...
function getRIASECProfile(college: string, department: string, major: string): Partial<Record<Dim, number>> {
  ...
  const profileMap: Record<string, Partial<Record<Dim, number>>> = {
    // 인문대학
    '중어중문학전공': { R: 0.15, I: 0.7, A: 0.8, S: 0.75, E: 0.5, C: 0.5 }, // S 강조 (비즈니스/통역 특성)
    '중어중문학': { R: 0.15, I: 0.7, A: 0.8, S: 0.75, E: 0.5, C: 0.5 },
    '일어일문학전공': { R: 0.15, I: 0.7, A: 0.8, S: 0.75, E: 0.5, C: 0.5 }, // S 강조 (비즈니스/통역 특성)
    '일어일문학': { R: 0.15, I: 0.7, A: 0.8, S: 0.75, E: 0.5, C: 0.5 },
    '아랍지역학전공': { R: 0.2, I: 0.8, A: 0.75, S: 0.7, E: 0.6, C: 0.5 },
    '아랍지역학': { R: 0.2, I: 0.8, A: 0.75, S: 0.7, E: 0.6, C: 0.5 },
    '글로벌한국어학전공': { R: 0.15, I: 0.7, A: 0.75, S: 0.75, E: 0.5, C: 0.6 },
    '글로벌한국어학': { R: 0.15, I: 0.7, A: 0.75, S: 0.75, E: 0.5, C: 0.6 },
    '국어국문학전공': { R: 0.15, I: 0.75, A: 0.9, S: 0.6, E: 0.4, C: 0.5 }, // A 더 강조 (문학 창작/비평 특성)
    '국어국문학': { R: 0.15, I: 0.75, A: 0.9, S: 0.6, E: 0.4, C: 0.5 },
    '영어영문학전공': { R: 0.15, I: 0.75, A: 0.85, S: 0.7, E: 0.6, C: 0.5 }, // E 약간 강조 (국제 비즈니스 특성)
    '영어영문학': { R: 0.15, I: 0.75, A: 0.85, S: 0.7, E: 0.6, C: 0.5 },
    '미술사·역사학전공': { R: 0.2, I: 0.85, A: 0.7, S: 0.4, E: 0.3, C: 0.75 }, // 탐구형 중심으로 변경
    '미술사·역사학': { R: 0.2, I: 0.85, A: 0.7, S: 0.4, E: 0.3, C: 0.75 },
    '문헌정보학전공': { R: 0.2, I: 0.8, A: 0.4, S: 0.6, E: 0.25, C: 0.9 },
    '문헌정보학': { R: 0.2, I: 0.8, A: 0.4, S: 0.6, E: 0.25, C: 0.9 },
    '글로벌문화콘텐츠학전공': { R: 0.2, I: 0.65, A: 0.85, S: 0.6, E: 0.75, C: 0.5 },
    '글로벌문화콘텐츠학': { R: 0.2, I: 0.65, A: 0.85, S: 0.6, E: 0.75, C: 0.5 },
    '문예창작학과': { R: 0.15, I: 0.7, A: 0.95, S: 0.6, E: 0.5, C: 0.4 },
    '문예창작': { R: 0.15, I: 0.7, A: 0.95, S: 0.6, E: 0.5, C: 0.4 },
    '사학과': { R: 0.2, I: 0.9, A: 0.6, S: 0.4, E: 0.25, C: 0.8 },
    '사학': { R: 0.2, I: 0.9, A: 0.6, S: 0.4, E: 0.25, C: 0.8 },
    '미술사학과': { R: 0.2, I: 0.85, A: 0.8, S: 0.4, E: 0.3, C: 0.7 }, // 탐구형 중심으로 변경
    '미술사학': { R: 0.2, I: 0.85, A: 0.8, S: 0.4, E: 0.3, C: 0.7 },
    '철학과': { R: 0.15, I: 0.9, A: 0.6, S: 0.4, E: 0.2, C: 0.5 },
    '철학': { R: 0.15, I: 0.9, A: 0.6, S: 0.4, E: 0.2, C: 0.5 },
    
    // 사회과학대학
    '행정학전공': { R: 0.2, I: 0.6, A: 0.25, S: 0.75, E: 0.5, C: 0.9 },
    '행정학': { R: 0.2, I: 0.6, A: 0.25, S: 0.75, E: 0.5, C: 0.9 },
    '정치외교학전공': { R: 0.2, I: 0.65, A: 0.3, S: 0.75, E: 0.85, C: 0.5 },
    '정치외교학': { R: 0.2, I: 0.65, A: 0.3, S: 0.75, E: 0.85, C: 0.5 },
    '경제학전공': { R: 0.2, I: 0.8, A: 0.3, S: 0.5, E: 0.9, C: 0.75 },
    '경제학': { R: 0.2, I: 0.8, A: 0.3, S: 0.5, E: 0.9, C: 0.75 },
    '국제통상학전공': { R: 0.2, I: 0.75, A: 0.4, S: 0.7, E: 0.85, C: 0.65 }, // I 강조, E 낮춤
    '국제통상학': { R: 0.2, I: 0.75, A: 0.4, S: 0.7, E: 0.85, C: 0.65 },
    '응용통계학전공': { R: 0.5, I: 0.95, A: 0.2, S: 0.25, E: 0.4, C: 0.9 },
    '응용통계학': { R: 0.5, I: 0.95, A: 0.2, S: 0.25, E: 0.4, C: 0.9 },
    '법학과': { R: 0.2, I: 0.8, A: 0.25, S: 0.5, E: 0.65, C: 0.95 },
    '법학': { R: 0.2, I: 0.8, A: 0.25, S: 0.5, E: 0.65, C: 0.95 },
    
    // 경영대학
    '경영학전공': { R: 0.2, I: 0.75, A: 0.3, S: 0.7, E: 0.95, C: 0.8 }, // S 추가 (직무 데이터 반영)
    '경영학': { R: 0.2, I: 0.75, A: 0.3, S: 0.7, E: 0.95, C: 0.8 },
    '글로벌비즈니스학전공': { R: 0.2, I: 0.7, A: 0.4, S: 0.85, E: 0.9, C: 0.75 }, // S 강조, E 낮춤
    '글로벌비즈니스학': { R: 0.2, I: 0.7, A: 0.4, S: 0.85, E: 0.9, C: 0.75 },
    '경영정보학과': { R: 0.5, I: 0.9, A: 0.3, S: 0.35, E: 0.75, C: 0.85 },
    '경영정보학': { R: 0.5, I: 0.9, A: 0.3, S: 0.35, E: 0.75, C: 0.85 },
    '국제통상학과': { R: 0.2, I: 0.75, A: 0.4, S: 0.7, E: 0.85, C: 0.65 }, // I 강조, E 낮춤
    
    // 미디어·휴먼라이프대학
    '디지털미디어학부': { R: 0.25, I: 0.75, A: 0.85, S: 0.5, E: 0.8, C: 0.6 },
    '디지털미디어학': { R: 0.25, I: 0.75, A: 0.85, S: 0.5, E: 0.8, C: 0.6 },
    '디지털미디어': { R: 0.25, I: 0.75, A: 0.85, S: 0.5, E: 0.8, C: 0.6 },
    '청소년지도학전공': { R: 0.2, I: 0.5, A: 0.4, S: 0.95, E: 0.7, C: 0.3 },
    '청소년지도학': { R: 0.2, I: 0.5, A: 0.4, S: 0.95, E: 0.7, C: 0.3 },
    '아동학전공': { R: 0.2, I: 0.6, A: 0.5, S: 0.95, E: 0.3, C: 0.4 },
    '아동학': { R: 0.2, I: 0.6, A: 0.5, S: 0.95, E: 0.3, C: 0.4 },
    
    // 인공지능·소프트웨어융합대학
    '응용소프트웨어전공': { R: 0.6, I: 0.95, A: 0.2, S: 0.25, E: 0.5, C: 0.85 },
    '응용소프트웨어': { R: 0.6, I: 0.95, A: 0.2, S: 0.25, E: 0.5, C: 0.85 },
    '데이터사이언스전공': { R: 0.6, I: 0.95, A: 0.2, S: 0.25, E: 0.5, C: 0.9 },
    '데이터사이언스': { R: 0.6, I: 0.95, A: 0.2, S: 0.25, E: 0.5, C: 0.9 },
    '인공지능전공': { R: 0.65, I: 0.95, A: 0.2, S: 0.25, E: 0.5, C: 0.85 },
    '인공지능': { R: 0.65, I: 0.95, A: 0.2, S: 0.25, E: 0.5, C: 0.85 },
    '디지털콘텐츠디자인학과': { R: 0.3, I: 0.75, A: 0.9, S: 0.5, E: 0.7, C: 0.6 },
    '디지털콘텐츠디자인학': { R: 0.3, I: 0.75, A: 0.9, S: 0.5, E: 0.7, C: 0.6 },
    '디지털콘텐츠디자인': { R: 0.3, I: 0.75, A: 0.9, S: 0.5, E: 0.7, C: 0.6 },
    
    // 미래융합대학
    '창의융합인재학부': { R: 0.25, I: 0.8, A: 0.75, S: 0.7, E: 0.8, C: 0.6 },
    '창의융합인재학': { R: 0.25, I: 0.8, A: 0.75, S: 0.7, E: 0.8, C: 0.6 },
    '사회복지학과': { R: 0.2, I: 0.5, A: 0.3, S: 0.95, E: 0.65, C: 0.4 },
    '사회복지학': { R: 0.2, I: 0.5, A: 0.3, S: 0.95, E: 0.65, C: 0.4 },
    '부동산학과': { R: 0.25, I: 0.65, A: 0.3, S: 0.6, E: 0.9, C: 0.8 },
    '부동산학': { R: 0.25, I: 0.65, A: 0.3, S: 0.6, E: 0.9, C: 0.8 },
    '법무행정학과': { R: 0.2, I: 0.6, A: 0.25, S: 0.7, E: 0.75, C: 0.9 },
    '법무행정학': { R: 0.2, I: 0.6, A: 0.25, S: 0.7, E: 0.75, C: 0.9 },
    '심리치료학과': { R: 0.2, I: 0.85, A: 0.5, S: 0.95, E: 0.3, C: 0.4 },
    '심리치료학': { R: 0.2, I: 0.85, A: 0.5, S: 0.95, E: 0.3, C: 0.4 },
    '미래융합경영학과': { R: 0.2, I: 0.8, A: 0.4, S: 0.6, E: 0.9, C: 0.75 },
    '미래융합경영학': { R: 0.2, I: 0.8, A: 0.4, S: 0.6, E: 0.9, C: 0.75 },
    '멀티디자인학과': { R: 0.3, I: 0.7, A: 0.9, S: 0.5, E: 0.8, C: 0.6 },
    '멀티디자인학': { R: 0.3, I: 0.7, A: 0.9, S: 0.5, E: 0.8, C: 0.6 },
    '멀티디자인': { R: 0.3, I: 0.7, A: 0.9, S: 0.5, E: 0.8, C: 0.6 },
    '회계세무학과': { R: 0.2, I: 0.75, A: 0.2, S: 0.4, E: 0.8, C: 0.95 }, // E 추가 (직무 데이터 반영: 진취형 89)
    '회계세무학': { R: 0.2, I: 0.75, A: 0.2, S: 0.4, E: 0.8, C: 0.95 },
    '계약학과': { R: 0.2, I: 0.65, A: 0.3, S: 0.6, E: 0.75, C: 0.9 },
    '계약학': { R: 0.2, I: 0.65, A: 0.3, S: 0.6, E: 0.75, C: 0.9 },
    
    // 화학·생명과학대학
    '화학나노학전공': { R: 0.8, I: 0.9, A: 0.2, S: 0.3, E: 0.4, C: 0.75 },
    '화학나노학': { R: 0.8, I: 0.9, A: 0.2, S: 0.3, E: 0.4, C: 0.75 },
    '융합에너지학전공': { R: 0.8, I: 0.9, A: 0.3, S: 0.3, E: 0.7, C: 0.7 },
    '융합에너지학': { R: 0.8, I: 0.9, A: 0.3, S: 0.3, E: 0.7, C: 0.7 },
    '식품영양학전공': { R: 0.8, I: 0.75, A: 0.5, S: 0.8, E: 0.35, C: 0.5 },
    '식품영양학': { R: 0.8, I: 0.75, A: 0.5, S: 0.8, E: 0.35, C: 0.5 },
    '시스템생명과학전공': { R: 0.8, I: 0.95, A: 0.4, S: 0.25, E: 0.3, C: 0.75 },
    '시스템생명과학': { R: 0.8, I: 0.95, A: 0.4, S: 0.25, E: 0.3, C: 0.75 },
    '물리학과': { R: 0.5, I: 0.95, A: 0.2, S: 0.25, E: 0.2, C: 0.8 },
    '물리학': { R: 0.5, I: 0.95, A: 0.2, S: 0.25, E: 0.2, C: 0.8 },
    '수학과': { R: 0.4, I: 0.95, A: 0.2, S: 0.25, E: 0.2, C: 0.85 },
    '수학': { R: 0.4, I: 0.95, A: 0.2, S: 0.25, E: 0.2, C: 0.85 },
    
    // 스마트시스템 공과대학
    '화학공학전공': { R: 0.8, I: 0.9, A: 0.3, S: 0.3, E: 0.5, C: 0.85 }, // C 강조, R 낮춤 (차별화)
    '화학공학': { R: 0.8, I: 0.9, A: 0.3, S: 0.3, E: 0.5, C: 0.85 },
    '신소재공학전공': { R: 0.85, I: 0.95, A: 0.3, S: 0.25, E: 0.5, C: 0.8 }, // I 더 강조 (차별화)
    '신소재공학': { R: 0.85, I: 0.95, A: 0.3, S: 0.25, E: 0.5, C: 0.8 },
    '환경시스템공학전공': { R: 0.85, I: 0.8, A: 0.25, S: 0.6, E: 0.4, C: 0.75 },
    '환경시스템공학': { R: 0.85, I: 0.8, A: 0.25, S: 0.6, E: 0.4, C: 0.75 },
    '건설환경공학전공': { R: 0.9, I: 0.75, A: 0.25, S: 0.5, E: 0.4, C: 0.8 },
    '건설환경공학': { R: 0.9, I: 0.75, A: 0.25, S: 0.5, E: 0.4, C: 0.8 },
    '스마트모빌리티공학전공': { R: 0.9, I: 0.85, A: 0.3, S: 0.35, E: 0.6, C: 0.8 },
    '스마트모빌리티공학': { R: 0.9, I: 0.85, A: 0.3, S: 0.35, E: 0.6, C: 0.8 },
    '기계공학전공': { R: 0.95, I: 0.85, A: 0.2, S: 0.3, E: 0.4, C: 0.8 },
    '기계공학': { R: 0.95, I: 0.85, A: 0.2, S: 0.3, E: 0.4, C: 0.8 },
    '로봇공학전공': { R: 0.95, I: 0.9, A: 0.3, S: 0.3, E: 0.5, C: 0.85 },
    '로봇공학': { R: 0.95, I: 0.9, A: 0.3, S: 0.3, E: 0.5, C: 0.85 },
    
    // 반도체·ICT대학
    '컴퓨터공학전공': { R: 0.75, I: 0.95, A: 0.2, S: 0.3, E: 0.5, C: 0.85 }, // R 추가 (직무 데이터 반영: 현실형 80)
    '컴퓨터공학': { R: 0.75, I: 0.95, A: 0.2, S: 0.3, E: 0.5, C: 0.85 },
    '정보통신공학전공': { R: 0.7, I: 0.9, A: 0.25, S: 0.5, E: 0.8, C: 0.8 },
    '정보통신공학': { R: 0.7, I: 0.9, A: 0.25, S: 0.5, E: 0.8, C: 0.8 },
    '전기공학전공': { R: 0.9, I: 0.9, A: 0.2, S: 0.3, E: 0.5, C: 0.8 },
    '전기공학': { R: 0.9, I: 0.9, A: 0.2, S: 0.3, E: 0.5, C: 0.8 },
    '전자공학전공': { R: 0.85, I: 0.9, A: 0.3, S: 0.3, E: 0.5, C: 0.8 },
    '전자공학': { R: 0.85, I: 0.9, A: 0.3, S: 0.3, E: 0.5, C: 0.8 },
    '반도체공학부': { R: 0.85, I: 0.95, A: 0.2, S: 0.25, E: 0.5, C: 0.85 },
    '반도체공학': { R: 0.85, I: 0.95, A: 0.2, S: 0.25, E: 0.5, C: 0.85 },
    '산업경영공학과': { R: 0.6, I: 0.85, A: 0.25, S: 0.5, E: 0.8, C: 0.8 },
    '산업경영공학': { R: 0.6, I: 0.85, A: 0.25, S: 0.5, E: 0.8, C: 0.8 },
    
    // 스포츠·예술대학
    '비주얼커뮤니케이션디자인전공': { R: 0.25, I: 0.65, A: 0.95, S: 0.4, E: 0.85, C: 0.5 }, // E 강조 (차별화)
    '비주얼커뮤니케이션디자인': { R: 0.25, I: 0.65, A: 0.95, S: 0.4, E: 0.85, C: 0.5 },
    '인더스트리얼디자인전공': { R: 0.8, I: 0.75, A: 0.9, S: 0.35, E: 0.7, C: 0.6 },
    '인더스트리얼디자인': { R: 0.8, I: 0.75, A: 0.9, S: 0.35, E: 0.7, C: 0.6 },
    '영상애니메이션디자인전공': { R: 0.3, I: 0.8, A: 0.9, S: 0.5, E: 0.7, C: 0.6 }, // I 강조, A 낮춤 (차별화)
    '영상애니메이션디자인': { R: 0.3, I: 0.8, A: 0.9, S: 0.5, E: 0.7, C: 0.6 },
    '패션디자인전공': { R: 0.3, I: 0.6, A: 0.9, S: 0.75, E: 0.8, C: 0.5 }, // S 강조, A 낮춤 (차별화)
    '패션디자인': { R: 0.3, I: 0.6, A: 0.9, S: 0.75, E: 0.8, C: 0.5 },
    '체육학전공': { R: 0.95, I: 0.4, A: 0.3, S: 0.9, E: 0.8, C: 0.3 },
    '체육학': { R: 0.95, I: 0.4, A: 0.3, S: 0.9, E: 0.8, C: 0.3 },
    '스포츠산업학전공': { R: 0.75, I: 0.5, A: 0.3, S: 0.85, E: 0.9, C: 0.6 },
    '스포츠산업학': { R: 0.75, I: 0.5, A: 0.3, S: 0.85, E: 0.9, C: 0.6 },
    '스포츠지도학전공': { R: 0.9, I: 0.4, A: 0.3, S: 0.95, E: 0.8, C: 0.3 },
    '스포츠지도학': { R: 0.9, I: 0.4, A: 0.3, S: 0.95, E: 0.8, C: 0.3 },
    '건반음악전공': { R: 0.2, I: 0.6, A: 0.95, S: 0.8, E: 0.75, C: 0.5 },
    '건반음악': { R: 0.2, I: 0.6, A: 0.95, S: 0.8, E: 0.75, C: 0.5 },
    '보컬뮤직전공': { R: 0.2, I: 0.5, A: 0.95, S: 0.85, E: 0.8, C: 0.4 },
    '보컬뮤직': { R: 0.2, I: 0.5, A: 0.95, S: 0.85, E: 0.8, C: 0.4 },
    '작곡전공': { R: 0.2, I: 0.8, A: 0.95, S: 0.7, E: 0.65, C: 0.5 },
    '작곡': { R: 0.2, I: 0.8, A: 0.95, S: 0.7, E: 0.65, C: 0.5 },
    '연극·영화전공': { R: 0.2, I: 0.5, A: 0.95, S: 0.9, E: 0.85, C: 0.4 },
    '연극·영화': { R: 0.2, I: 0.5, A: 0.95, S: 0.9, E: 0.85, C: 0.4 },
    '뮤지컬공연전공': { R: 0.2, I: 0.5, A: 0.95, S: 0.9, E: 0.85, C: 0.4 },
    '뮤지컬공연': { R: 0.2, I: 0.5, A: 0.95, S: 0.9, E: 0.85, C: 0.4 },
    '바둑학과': { R: 0.5, I: 0.9, A: 0.7, S: 0.4, E: 0.3, C: 0.8 },
    '바둑학': { R: 0.5, I: 0.9, A: 0.7, S: 0.4, E: 0.3, C: 0.8 },
    
    // 건축대학
    '건축학전공': { R: 0.9, I: 0.75, A: 0.85, S: 0.35, E: 0.5, C: 0.7 },
    '건축학': { R: 0.9, I: 0.75, A: 0.85, S: 0.35, E: 0.5, C: 0.7 },
    '전통건축전공': { R: 0.9, I: 0.8, A: 0.85, S: 0.35, E: 0.4, C: 0.75 },
    '전통건축': { R: 0.9, I: 0.8, A: 0.85, S: 0.35, E: 0.4, C: 0.75 },
    '공간디자인학과': { R: 0.8, I: 0.7, A: 0.9, S: 0.4, E: 0.7, C: 0.6 },
    '공간디자인학': { R: 0.8, I: 0.7, A: 0.9, S: 0.4, E: 0.7, C: 0.6 },
    '공간디자인': { R: 0.8, I: 0.7, A: 0.9, S: 0.4, E: 0.7, C: 0.6 },
  };
  ...
  if (college.includes('인문')) {
    return { R: 0.15, I: 0.75, A: 0.65, S: 0.4, E: 0.35, C: 0.6 };
  }

  // 사회과학대학 계열
  if (college.includes('사회과학')) {
    return { R: 0.2, I: 0.75, A: 0.3, S: 0.7, E: 0.5, C: 0.5 };
  }

  // 경영대학 계열
  if (college.includes('경영')) {
    return { R: 0.2, I: 0.7, A: 0.3, S: 0.5, E: 0.9, C: 0.75 };
  }

  // 미디어·휴먼라이프대학 계열
  if (college.includes('미디어')) {
    return { R: 0.25, I: 0.4, A: 0.6, S: 0.85, E: 0.7, C: 0.5 };
  }

  // 인공지능·소프트웨어 계열
  if (college.includes('인공지능') || college.includes('소프트웨어')) {
    return { R: 0.6, I: 0.85, A: 0.2, S: 0.25, E: 0.4, C: 0.75 };
  }

  // 화학·생명과학대학 계열
  if (college.includes('화학') || college.includes('생명과학')) {
    return { R: 0.7, I: 0.85, A: 0.3, S: 0.3, E: 0.3, C: 0.6 };
  }

  // 공과대학 계열
  if (college.includes('공과') || college.includes('시스템')) {
    return { R: 0.85, I: 0.75, A: 0.3, S: 0.3, E: 0.4, C: 0.7 };
  }

  // 반도체·ICT대학 계열
  if (college.includes('반도체') || college.includes('ICT')) {
    return { R: 0.75, I: 0.9, A: 0.2, S: 0.3, E: 0.4, C: 0.75 };
  }

  // 스포츠·예술대학 계열
  if (college.includes('스포츠') || college.includes('예술')) {
    return { R: 0.3, I: 0.5, A: 0.85, S: 0.75, E: 0.65, C: 0.5 };
  }

  // 건축대학 계열
  if (college.includes('건축')) {
    return { R: 0.8, I: 0.7, A: 0.8, S: 0.35, E: 0.5, C: 0.6 };
  }

  // 미래융합대학 계열
  if (college.includes('미래융합')) {
    return { R: 0.25, I: 0.7, A: 0.5, S: 0.65, E: 0.7, C: 0.6 };
  }

  // 기본값 (방목기초교육대학 등)
  return { R: 0.2, I: 0.7, A: 0.5, S: 0.65, E: 0.4, C: 0.6 };
}
