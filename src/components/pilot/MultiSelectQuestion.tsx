...
const COLORS = {
  ...
  primary: '#1E3A5F',
  secondary: '#4A6FA5',
  accent: '#10B981', // emerald for multi-select
  muted: '#94A3B8',
  text: {
    primary: '#1E293B',
    secondary: '#475569',
            ...
            <div className="flex-1 lg:max-w-md mb-10 lg:mb-0">
              ...
              <AnimatePresence mode="wait">
                ...
                >
                  ...
                  >
                    최대 {maxSelections}개 선택 가능 · {selectedCount}/{maxSelections} 선택됨
                  </p>
                </motion.div>
              </AnimatePresence>
                    ...
                    >
                      ...
                      {!isSelected && !isDisabled && (
                        <div
                          ...
                          style={{ background: 'linear-gradient(135deg, rgba(16,185,129,0.02) 0%, rgba(5,150,105,0.04) 100%)' }}
                        />
                      )}
      ...
      >
        <div className="max-w-4xl mx-auto px-6 flex items-center justify-between">
          <p className="text-xs" style={{ color: COLORS.muted }}>
            여러 개를 선택할 수 있습니다 · 선택 후 Enter로 다음
          </p>
          <div className="flex items-center gap-6">
            <div className="flex items-center gap-2">
              ...
              <span className="text-xs" style={{ color: COLORS.text.secondary }}>
                {selectedCount}/{maxSelections} 선택
              </span>
            </div>
            <div
